jQuery("#simulation")
  .on("click", ".s-2a550e8d-9b1c-45ce-92f7-027dfb99192d .click", function(event, data) {
  ...
  .on("keyup.jim", ".s-2a550e8d-9b1c-45ce-92f7-027dfb99192d .keyup", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
